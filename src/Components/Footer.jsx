        ...
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          <div className="md:flex md:justify-between">
            <div className="mb-6 md:mb-0">
              <a href="https://devnuxes.com/" className="flex items-center">
                <img
                  src="#"
                  className="h-8 me-3"
                  // alt="DevNuxes Logo"
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              ...
              <div>
                ...
                <ul className="font-medium">
                  ...
                  <li>
                    <a
                      href="https://linkedin/in/devbasitali"
                      className="hover:underline text-white"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
          ...
          <hr className="my-6 border-gray-200 sm:mx-auto lg:my-8 text-white" />
          <div className="sm:flex sm:items-center sm:justify-between text-white">
            <span className="text-sm sm:text-center text-white">
              © 2024{" "}
              <a href="https://devnuxes.com/" className="hover:underline text-white">
                DevNuxes™
              </a>
              . All Rights Reserved.
            </span>
            <div className="flex mt-4 sm:justify-center sm:mt-0 text-white">
              <a
                href="https://www.facebook.com/devbasitali"
              ...
              <a
                href="https://www.twitter.com/devbasitali"
                className="text-gray-500 hover:text-gray-900 ms-5 text-white"
              >
                <svg
                  className="w-4 h-4"
                  aria-hidden="true"
              ...
              <a
                href="https://www.github.com/devbasitali"
                className="text-gray-500 hover:text-gray-900 ms-5 text-white"
              >
                <svg
                  className="w-4 h-4"
              ...
              <div>
                ...
                <ul className="text-gray-500 dark:text-gray-400 font-medium">
                  <li className="mb-4">
                    <a
                      href="https://github.com/devBasitali"
                      className="hover:underline " target="blank">
                      Github
                    </a>
                  </li>
                  <li>
