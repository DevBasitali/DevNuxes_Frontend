...
import webdesign_icon from "../Images/Icons/web_d.svg";

const WebDesignCard = () => {
  return (
    <>
      <div className="grid grid-cols-2 justify-center gap-8 mx-20 mt-10">
        <div className="mb-5">
          <div class="flex items-center justify-center ">
            <img src={webdesign_icon} alt="" class="h-12 w-12 mt-5 mr-1" />
